...
alter table  site_item_numeric_metadata drop constraint if exists site_item_numeric_metadata_site_id_item_id_metadata_type_key;
drop index if exists site_item_numeric_metadata_site_id_item_id_metadata_type_key;
